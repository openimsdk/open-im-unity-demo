        ...
        private sealed class ResourceIniter
        {
            ...
            private void OnLoadPackageVersionListSuccess(string fileUri, byte[] bytes, float duration, object userData)
            {
                ...
                try
                {
                    ...
                    {
                        // UnityEngine.Debug.Log(string.Format("FileSystem = {0}",fileSystem.Name));
                        ...
                        foreach (int resourceIndex in resourceIndexes)
                        {
                            ...
                            // UnityEngine.Debug.Log(string.Format("FileSystem ResourceIndex = {0}, ResourceName = {1} {2}",resourceIndex,resource.Name,resource.Extension));
                    ...
                    foreach (PackageVersionList.Resource resource in resources)
                    {
                        ...
                        // UnityEngine.Debug.Log(string.Format("Resource = {0} {1}",resource.Name,resource.Extension));
                        ...
                        foreach (int assetIndex in assetIndexes)
                        {
                            ...
                            // UnityEngine.Debug.Log(string.Format("Resource Asset = {0}",asset.Name));
