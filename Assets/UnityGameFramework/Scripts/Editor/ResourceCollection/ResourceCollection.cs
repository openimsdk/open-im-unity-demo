...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        public bool AssignAsset(string guid, string name, string variant)
        {
            ...
            bool isLua = guid.Contains(".lua");
            string assetName = isLua ? guid : AssetDatabase.GUIDToAssetPath(guid);
            ...
            if (isLua) {
                resource.FileSystem = "Lua";
                // Lua 资源加密
                resource.LoadType = LoadType.LoadFromBinary;
                // resource.LoadType = LoadType.LoadFromBinaryAndDecrypt;
            }
